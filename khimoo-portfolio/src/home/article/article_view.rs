use super::super::data_loader::{use_article_content, DataLoader};
use super::article_content::ArticleContent;
use super::article_header::ArticleHeader;
use super::article_state_renderer::ArticleStateRenderer;
use yew::prelude::*;
